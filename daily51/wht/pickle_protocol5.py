"""
Pickle v5 sugar functions

*Example*
print(f"raw_df = p5.loads_b64('{p5.dumps_b64(raw_df)}')")
"""
import pickle
import base64
...
def dump(obj, file):
    if isinstance(file, str):
        with open(file, 'wb') as f:
            return pickle.dump(obj, f, protocol=5)
